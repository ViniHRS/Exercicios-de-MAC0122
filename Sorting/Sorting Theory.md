...
[3 | 5 9 8 0]   
A princípio, considera-se o início do vetor como ordenado.  
...
[0 3 | **5** 9 8]  
5 é o menor elemento da parte não ordenada e é maior do que 3,  
logo ele deve ser inserido à direita do 3  

Por fim, ao repetir o processo, deve-se obter o vetor ordenado.  
[0 3 5 | 9 **8**] -> [0 3 5 8 | **9**] -> [0 3 5 8 9]  
...
[4 5 1 **0** 7]  
Procura-se no vetor o menor elemento, que no caso é 0.  
Ao encontrar o menor elemento, deve-se deslocá-lo para a posição inicial  

[**0** | 5 1 4 7]  
Agora, procura-se o menor elemento da parte não ordenada, deslocando-o logo depois do 0  
